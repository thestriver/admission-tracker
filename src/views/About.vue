<template>
	<index-navbar />
  <div class="mt-10 px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
    <div class="grid gap-5 row-gap-10 lg:grid-cols-2">
      ...
      <div>
        <img class="object-cover w-full h-20 rounded shadow-lg sm:h-96" src="https://images.pexels.com/photos/927022/pexels-photo-927022.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=3&amp;h=750&amp;w=1260" alt="" />
      </div>
    </div>
  </div>
  ...
  <section class="bg-coolGray-100 text-coolGray-800">
		<div class="container flex flex-col justify-center p-4 mx-auto md:p-8">
			...
			<h1 class="mb-12 text-4xl font-bold leading-none text-center sm:text-5xl">Frequently Asked Questions</h1>
...
<!-- Testimonials -->
<section class="my-8">
		<div class="container mx-auto flex flex-col items-center p-4 space-y-6 md:p-8">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" class="w-16 h-16 text-violet-600">
			...
			<p class="px-6 py-2 text-2xl font-semibold text-center sm:font-bold sm:text-3xl md:text-4xl lg:max-w-2xl xl:max-w-4xl text-coolGray-700">"Veniam quidem animi ea maxime odit fugiat architecto perferendis ipsum perspiciatis iusto, provident qui nam dolorum corporis."</p>
			<div class="flex justify-center space-x-3">
				<img src="https://source.unsplash.com/80x80/?portrait" alt="" class="w-20 h-20 bg-center bg-cover rounded-md bg-coolGray-300">
				<div>
					<p class="leading-tight">Leroy Jenkins</p>
					<p class="text-sm leading-tight text-coolGray-700">Founder, Company</p>
					<a class="flex items-center py-2 space-x-1 text-sm text-violet-600" href="/">
...
<!-- Trusted -->
  ...
  <!-- Lets Talk -->
	<div class="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 bg-gray-100 text-coolGray-800">
		<div class="flex flex-col justify-between">
			...
			<img :src="smilingstudents" alt="Contact our customer support" class="pr-6 rounded h-52 md:h-64">
		</div>
		<form novalidate="" class="space-y-6 ng-untouched ng-pristine ng-valid mt-20 pl-20 ">
			<div>
				<label for="name" class="text-sm">Full name</label>
				<input id="name" type="text" placeholder="" class="w-full p-3 rounded">
			</div>
			<div>
			...
			<button type="submit" class="w-full p-3 text-sm font-bold tracking-wide uppercase rounded bg-green-600 text-coolGray-50">Send Message</button>
		</form>
	</div>
...
import smilingstudents from "@/assets/img/smilingstudents.jpeg"
